...
<head>
    ...
    <title>My Appointments - Barber Queue System</title>
    <style>
                ...
                <table class="appointments-table">
                    ...
                    <tbody>
                        ...
                        try {
                            ...
                            int cid = CustomerPojo.getCid(); // Logged-in customer ID

                            String sql = "SELECT a.aid, s.sname, s.sdesc, s.sprice, a.status " +
                                         "FROM appointment a " +
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="DeleteAppointment.jsp?aid=<%= rs.getInt("aid") %>" class="delete-btn" onclick="return confirmDelete()">
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="empty-state">
                                    ...
                                    <p>You haven't booked any appointments yet. <a href="bookApointment.jsp" style="color: var(--primary);">Book your first appointment now!</a></p>
                                </div>
                            </td>
                        </tr>
                        <%
        ...
        <footer class="footer">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <p><a href="bookApointment.jsp">Book Appointment</a></p>
