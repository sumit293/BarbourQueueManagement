...
<head>
    ...
    <title>Manage Services - Barber Dashboard</title>
    <style>
...
<body>
        ...
        <div class="nav-menu">
            <div class="nav-section">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="manageAppointment.jsp">
        ...
        <main class="dashboard-content">
            <div class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">Manage your barber services and pricing</p>
                </div>
            ...
            <!-- Add Service Button -->
            <a href="addServices.html" class="add-service-btn">
                <img src="data:image/svg+xml;base64," class="add-icon" alt="Add">
                Add New Service
            </a>
            ...
            <div class="stats-summary">
                ...
                <div class="stat-card popular">
                    <div class="stat-value" id="popularService">0</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="DeleteServices.jsp?sid=<%=rs.getInt("sid") %>" class="btn btn-delete" onclick="return confirmDelete()">
        ...
        <footer class="footer">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <p><a href="manageAppointment.jsp">Manage Appointments</a></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('averagePrice').textContent = '$' + <%= String.format("%.2f", averagePrice) %>;
            document.getElementById('activeServices').textContent = <%= totalServices %>;
            document.getElementById('popularService').textContent = <%= totalServices > 0 ? 1 : 0 %>;
